...
#define coverage output variables // chmod u+x generateCoverageView.sh
...
lcov --remove $BUILD/$COVFILENAME "SpannungsteilerLogikTest.cpp" --output-file $BUILD/$COVFILENAME
